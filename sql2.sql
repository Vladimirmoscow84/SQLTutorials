...
JOIN first_date f ON a.player_id = f.player_id 
                AND a.event_date = f.first_event
 --эквивалент
 LEFT JOIN first_date f ON a.player_id = f.player_id
 WHERE a.event_date = f.first_event
